...
public class Update {
    ...
    public static void main(String[] args) {
        ...
        try (MongoClient mongoClient = MongoClients.create(System.getProperty("mongodb.uri"))) {
            ...
            // updateOne takes 2 params -
            // - a filter that identifies the document we want to update.
            ...
            updateResult = gradesCollection.updateOne(filter, updateOperation, options); // options indicates upsert
            ...
            // ----------------------------------------- Combine FIND and UPDATE
            
            // findOneAndUpdate
            filter = eq("student_id", 10000);
            
            // Different types of update operators
